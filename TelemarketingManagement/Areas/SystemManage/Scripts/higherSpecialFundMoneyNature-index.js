...
$(function () {
    ...
    window.operateFormatter = function (value, row, index) {
        return [
            '<a href="#" class="u-edit" data-u-url="/Admin/Manager/HigherSpecialFundMoneyNature/Edit/' + value + '">',
                '编辑',
                '<i class="fa fa-pencil" aria-hidden="true"></i>',
            '</a>',
            '<a href="#" class="u-delete" data-u-url="/Admin/Manager/HigherSpecialFundMoneyNature/Remove/' + value + '">',
                '删除',
