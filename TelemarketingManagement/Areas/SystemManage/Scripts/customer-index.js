$(function () {
    ...
    //转换为select2
    $(".form-edit .u-customer-select2").each(function () {
        //当前对象
        var $this = $(this);
    ...
    window.operateFormatter = function (value, row, index) {
        return [
            "<a href=\"#\" class=\"u-edit\" data-u-url=\"/SystemManage/Customer/Edit/" + value + "\">",
                "编辑",
                "<i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>",
            "</a>",
            "<a href=\"#\" class=\"u-delete\" data-u-url=\"/SystemManage/Customer/Remove/" + value + "\">",
                "删除",
