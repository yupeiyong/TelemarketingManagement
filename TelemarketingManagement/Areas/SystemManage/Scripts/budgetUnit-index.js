...
$(function () {
    ...
    window.operateFormatter = function (value, row, index) {
        return [
            '<a href="#" class="u-edit" data-u-url="/Admin/Manager/BudgetUnit/Edit/' + value + '">',
                '编辑',
                '<i class="fa fa-pencil" aria-hidden="true"></i>',
            '</a>',
            '<a href="#" class="u-delete" data-u-url="/Admin/Manager/BudgetUnit/Remove/' + value + '">',
                '删除',
    ...
    window.isDistrictLevelFormatter = function (value, row, index) {
        return value ? '<span>是</span>' : '<span>否</span>';
    }
