(function(e) {
    function q(b, a, c) { return"rgba(" + [Math.round(b[0] + (a[0] - b[0]) * c), Math.round(b[1] + (a[1] - b[1]) * c), Math.round(b[2] + (a[2] - b[2]) * c), b[3] + (a[3] - b[3]) * c].join(",") + ")" }

    var m = function() {}, j = e.getOptions(), g = e.each, n = e.extend, o = e.wrap, h = e.Chart, i = e.seriesTypes, k = i.pie, l = i.column, r = HighchartsAdapter.fireEvent;
    ...
    e.SVGRenderer.prototype.Element.prototype.fadeIn = function() { this.attr({ opacity: 0.1, visibility: "visible" }).animate({ opacity: 1 }, { duration: 250 }) };
    ...
    h.prototype.showDrillUpButton = function() {
        ...
        this.drillUpButton ? this.drillUpButton.attr({ text: a }).align() : this.drillUpButton = this.renderer.button(a, null, null, function() { b.drillUp() }).attr(n({ align: c.position.align, zIndex: 9 }, c.theme)).add().align(c.position, !1, c.relativeTo || "plotBox")
    };
    ...
    k.prototype.animateDrilldown = function(b) {
        ...
        b || g(this.points, function(a, b) {
            ...
            a.graphic.attr(e.merge(d, { start: f + b * s, end: f + (b + 1) * s })).animate(a.shapeArgs, e.merge(c, { step: function(a, d) { d.prop === "start" && this.attr({ fill: q(h, g, d.pos) }) } }))
        })
    };
    ...
    l.prototype.animateDrilldown = function(b) {
        ...
        b || (a.x += this.xAxis.oldPos - this.xAxis.pos, g(this.points, function(b) { b.graphic.attr(a).animate(b.shapeArgs, c) }))
    };
    ...
    o(e.Point.prototype, "init", function(b, a, c, d) {
        ...
        if (f.drilldown) {
            if (e.addEvent(f, "click", function() { f.doDrilldown() }),
                ...
                a.addClass("highcharts-drilldown-axis-label").css(b.options.drilldown.activeAxisLabelStyle).on("click", function() { f.doDrilldown && f.doDrilldown() })
            }
    ...
    var p,
        j = function(b) {
            b.call(this);
            g(this.points, function(a) { a.drilldown && a.graphic && a.graphic.attr({ "class": "highcharts-drilldown-point" }).css({ cursor: "pointer" }) })
        };
