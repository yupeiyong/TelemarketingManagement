...
(function() {
    ...
    function Eb(a, b, c, d) {
        ...
        if (u(b)) {
            ...
            for (var d =
                ...
                l = i[$a](),
                m = i[Sa](),
                p = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;)e.push(d), j === D[Da] ? d = bb(h + b * k, 0) : j === D[Ra] ? d = bb(h, l + b * k) : !g && (j === D[ua] || j === D[Za]) ? d = bb(h, l, m + b * k * (j === D[ua] ? 1 : 7)) : d += j * k, b++;
            e.push(d);
    ...
    var ra = function(a) {
        var b = [], c, d;
        (function(a) {
            a && a.stops ? d = Na(a.stops, function(a) { return ra(a[1]) }) : (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/.exec(a)) ? b = [
                C(c[1]), C(c[2]),
                C(c[3]), parseFloat(c[4], 10)
            ] : (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(a)) ? b = [C(c[1], 16), C(c[2], 16), C(c[3], 16), 1] : (c = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(a)) && (b = [C(c[1]), C(c[2]), C(c[3]), 1])
        })(a);
        return{
            get: function(c) {
                var f;
    ...
    wa.prototype = {
        ...
        destroy: function() {
            ...
            a.safeRemoveChild(b);
            for (c && n(c, function(b) { a.safeRemoveChild(b) }); d && d.childNodes.length === 0;)b = d.parentNode, a.safeRemoveChild(d), d = b;
    ...
    Ha.prototype = {
        ...
        buildText: function(a) {
            for (var b = a.element,
                ...
                d = c.forExport,
                e = o(a.textStr,
                    "").toString().replace(/<(b|strong)>/g, "<span style=\"font-weight:bold\">").replace(/<(i|em)>/g, "<span style=\"font-style:italic\">").replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g),
                f = b.childNodes,
                g = /style="([^"]+)"/,
                h = /href="(http[^"]+)"/,
                i = v(b, "x"),
                ...
                l = j && j.lineHeight,
                m = f.length; m--;)b.removeChild(f[m]);
            k && !a.added && this.box.appendChild(b);
            e[e.length - 1] === "" && e.pop();
            n(e, function(e, f) {
                var m,
                    o = 0,
                    e = e.replace(/<span/g, "|||<span").replace(/<\/span>/g,
                        "</span>|||");
                m = e.split("|||");
                n(m, function(e) {
                    if (e !== "" || m.length === 1) {
        ...
        button: function(a, b, c, d, e, f, g, h) {
            ...
            J(i.element, ta ? "mouseout" : "mouseleave", function() { j !== 3 && (k = [e, f, g][j], l = [m, p, q][j], i.attr(k).css(l)) });
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            ...
            return r(q, {
                css: function(a) {
                    if (a) {
                        var b = {}, a = x(a);
                        n("fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration,textShadow".split(","), function(c) { a[c] !== w && (b[c] = a[c], delete a[c]) });
                        o.css(b)
                    }
                    return y.call(q, a)
                },
    ...
    if (!Z && !$) {
        Highcharts.VMLElement = F = {
            ...
            clip: function(a) {
                var b = this, c;
                a ? (c = a.members, ga(c, b), c.push(b), b.destroyClip = function() { ga(c, b) }, a = a.getCSS(b)) : (b.destroyClip && b.destroyClip(), a = { clip: fb ? "inherit" : "rect(auto)" });
                return b.css(a)
            },
    ...
    var Tb;
    if ($)
        Highcharts.CanVGRenderer = F = function() { za = "http://www.w3.org/1999/xhtml" }, F.prototype.symbols = {}, Tb = function() {
            function a() {
                var a = b.length, d;
                for (d = 0; d < a; d++)b[d]();
                b = []
    ...
    db.prototype = {
        ...
        getOffset: function() {
            ...
            if (j || a.isLinked) {
                ...
                n(e, function(b) { if (h === 0 || h === 2 || { 1: "left", 3: "right" }[h] === a.labelAlign)ba = s(f[b].getLabelSize(), ba) });
        ...
        render: function() {
            ...
            if (A || f)
                ...
                }), q && a.min === 0 && (j[-1] || (j[-1] = new Ma(a, -1, null, !0)), j[-1].render(-1))), p && n(g, function(b, c) { if (c % 2 === 0 && b < a.max)l[b] || (l[b] = new vb(a)), r = b + q, v = g[c + 1] !== w ? g[c + 1] + q : a.max, l[b].options = { from: e ? fa(r) : r, to: e ? fa(v) : v, color: p }, l[b].render(), l[b].isActive = !0 }), !a._addedPlotLB)
                    n((d.plotLines || []).concat(d.plotBands ||
                    []), function(b) { a.addPlotBandOrLine(b) }), a._addedPlotLB = !0;
            n([j, k, l], function(a) {
                var c, d, e = [], f = Fa ? Fa.duration || 500 : 0, g = function() { for (d = e.length; d--;)a[e[d]] && !a[e[d]].isActive && (a[e[d]].destroy(), delete a[e[d]]) };
    ...
    wb.prototype = {
        ...
        getAnchor: function(a, b) {
            ...
            c || (n(a, function(a) {
                ...
                e ? d.plotWidth - h : g, this.shared && !e && a.length > 1 && b ? b.chartY - f : e ? d.plotHeight - g :
                h
            ]);
            return Na(c, t)
        },
        ...
        refresh: function(a, b) {
            ...
            m && (!a.series || !a.series.noSharedTooltip) ? (c.hoverPoints = a, h && n(h,
                function(a) { a.setState() }), n(a, function(a) {
                a.setState("hover");
                ...
                for (d = l.length; d--;)
                    if (m = a.series, e = m[d ? "yAxis" : "xAxis"], l[d] && e)
                        if (h = d ? o(a.stackY, a.y) : a.x,
                            e.isLog && (h = na(h)), d === 1 && m.modifyValue && (h = m.modifyValue(h)), e = e.getPlotLinePath(h, 1), this.crosshairs[d])this.crosshairs[d].attr({ d: e, visibility: "visible" });
                        else {
        ...
        setDOMEvents: function() {
            ...
            this._events = c = [
                [b, "onmousedown", "onContainerMouseDown"], [b, "onmousemove", "onContainerMouseMove"], [
                    b, "onclick",
                    "onContainerClick"
                ], [b, "mouseleave", "onContainerMouseLeave"], [y, "mousemove", "onDocumentMouseMove"], [y, "mouseup", "onDocumentMouseUp"]
            ];
    ...
    eb.prototype = {
        init: function(a, b) {
            ...
            this.options = b;
            if (b.enabled)c.baseline = C(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = x(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.render(), J(c.chart, "endResize", function() { c.positionCheckboxes() })
        },
    ...
    yb.prototype = {
        ...
        hideLoading: function() {
            ...
            b && Bb(b, { opacity: 0 }, { duration: a.loading.hideDuration || 100, complete: function() { K(b, { display: S }) } });
            this.loadingShown = !1
        },
        get: function(a) {
        ...
        getStacks: function() {
            ...
            n(a.series, function(b) { if (b.options.stacking && (b.visible === !0 || a.options.chart.ignoreHiddenSeries === !1))b.stackKey = b.type + o(b.options.stack, "") })
        },
        ...
        isReadyToRender: function() {
            var a = this;
            return!Z && O == O.top && y.readyState !== "complete" || $ && !O.canvg ? ($ ? Tb.push(function() { a.firstRender() },
        ...
        select: function(a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", { accumulate: b }, function() {
                ...
                d.options.data[qa(c, d.data)] =
                    c.options;
                c.setState(a && "select");
                b || n(e.getSelectedPoints(), function(a) { if (a.selected && a !== c)a.selected = a.options.selected = !1, d.options.data[qa(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect") })
            })
        },
    ...
    Q.prototype = {
        ...
        destroy: function() {
            ...
            z(a, "destroy");
            aa(a);
            n(["xAxis", "yAxis"], function(b) { if (i = a[b])ga(i.series, a), i.isDirty = i.forceRedraw = !0, i.stacks = {} });
        ...
        drawTracker: function() {
            ...
            j ? j.attr({ d: d }) : (a.tracker = h.path(d).attr({ "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: Qb, fill: c ? Qb : S, "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2 }).add(a.group), n([a.tracker, a.markerGroup], function(a) {
                a.addClass("highcharts-tracker").on("mouseover",
                    p).on("mouseout", function(a) { g.onTrackerMouseOut(a) }).css(l);
    ...
    F = ha(Q, {
        ...
        drawPoints: function() {
            ...
            n(a.points, function(e) {
                ...
                if (f !== w && !isNaN(f) && e.y !== null)d = e.shapeArgs, g ? (Wa(g), g.animate(x(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
